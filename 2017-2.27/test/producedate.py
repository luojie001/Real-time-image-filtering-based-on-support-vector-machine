...
#产生的数据保存
#str1="/home/awen/Awen/baddate.txt"
#file1=open(str1,'w+')  
...
for k in range(0,length):
	...
	#print k,rec[k]
	wenli='0 1:'+str(float("%0.1f"%snrmy))+' 2:'+str(float("%0.1f"%np.max(ROAD)))+' 3:'+str(float("%0.1f"%wlk))+' 4:'+str(wenli0[0]*0.1)+' 5:'+str(wenli0[1])+' 6:'+str(wenli0[2])+' 7:'+str(wenli0[3]*10)
	print wenli
	#file1.write("%s\n"%wenli)
